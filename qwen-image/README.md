...
- Refreshed ROCm image evidence on 2026-04-01:
  - `qwen-image/out/matrix_new_qwen_refresh_20260401T1206Z/report.tsv`
  - `qwen-image/out/matrix_new_qwen_refresh_20260401T1206Z/tiny_256_s4.png`
  - `qwen-image/out/matrix_new_qwen_refresh_20260401T1206Z/small_384_s8.png`
  - `qwen-image/out/matrix_new_qwen_refresh_20260401T1206Z/medium_512_s12.png`
...
- `scripts/test_qwen_image_matrix.sh`: run a small resolution/step matrix against `Qwen-Image-2512`.
...
- On this host, keep `TORCH_ROCM_AOTRITON_ENABLE_EXPERIMENTAL=0` as the stability baseline for longer runs unless you are explicitly re-testing the newer ROCm attention kernels.
