...
CONF="${CONF:-0.25}"
IMGSZ="${IMGSZ:-640}"
PORT_TAG="${PORT_TAG:-vision-yolo-detect}"
OUT_JSON="${OUT_JSON:-$REPO_ROOT/vision-detection/out/yolo26_detect_result.json}"
OUT_IMAGE="${OUT_IMAGE:-$REPO_ROOT/vision-detection/out/yolo26_detect_annotated.png}"
