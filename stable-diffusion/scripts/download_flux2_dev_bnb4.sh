...
# This is the bitsandbytes/NF4 variant hosted by HF diffusers org.
MODEL_REPO="${MODEL_REPO:-diffusers/FLUX.2-dev-bnb-4bit}"
TARGET_DIR="${TARGET_DIR:-$MODEL_ROOT/flux2-dev-bnb4}"
