...
MODEL_ID="$MODEL_ROOT/sd35-medium"
DTYPE="${DTYPE:-float32}"
PORT="${PORT:-8001}"
CONTAINER="sd35-test"
OUT_DIR="$REPO_ROOT/stable-diffusion/out"
OUT_PATH="${OUT_PATH:-$OUT_DIR/sd35_sample.png}"
...
RESP_JSON="$RESP_DIR/sd35_sample_response.json"
HTTP_STATUS="$(mktemp "${TMPDIR:-/tmp}/sd35_sample_http.XXXXXX")"
